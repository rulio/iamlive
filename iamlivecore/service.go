...
var (
	...
	backgroundFlag            *bool
	debugFlag                 *bool
	forceWildcardResourceFlag *bool
	cpuProfileFlag            = flag.String("cpu-profile", "", "write a CPU profile to this file (for performance testing purposes)")
	csmPortFlag               *int
	awsRedirectHostFlag       *string
)
